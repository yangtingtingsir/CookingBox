...
*/
       ...
       // scene.lanternright =  scene.addSpriteLocPos('lantern_right', 720, -463).setOrigin(0.5, 0.05);   
        ...
        scene.gameheader =  scene.addSpriteLocPos('gameheader', 0, -950);
        ...
        scene.columnLeft =  scene.addSpriteLocPos('column_left', -250, -250);
        scene.columnRight =  scene.addSpriteLocPos('column_right', 250, -250);
        scene.gameftooer =  scene.addSpriteLocPos('gameftooer', 0, 650);
...
//        slotControls.linesPanel.setDepth(depth); 
        slotControls.totalbetPanel = scene.addSpriteLocPos('panel_totalbet', -20, 500);
        slotControls.totalbetPanel.setDepth(depth);
        slotControls.balancePanel = scene.addSpriteLocPos('panel_balance', -420, 500);
        slotControls.balancePanel.setDepth(depth);
        slotControls.winPanel = scene.addSpriteLocPos('panel_win', 400, 500);
        ...
        slotControls.totalBetMinusButton.create(-200, 650, 0.5, 0.5);
        ...
        slotControls.totalBetPlusButton.create(200, 650 , 0.5, 0.5);
...
//        slotControls.slotMaxBetButton.setDepth(depth);
        ...
        slotControls.slotAutoSpinButton.create(420, 650, 0.5, 0.5);
        ...
        slotControls.slotSpinButton.create(0, 650, 0.5, 0.5);
        ...
        slotControls.menuButton.create(-420, 650, 0.5, 0.5);
        ...
        slotControls.creditSumText = scene.add.bitmapText(scene.centerX - 360, scene.centerY + 500, 'gameFont_1', '' + scene.slotPlayer.coins, 60, 1).setOrigin(0.5);
...
//        slotControls.totalBetText.depth = depth;
        ...
        slotControls.totalBetSumText = scene.add.bitmapText(scene.centerX - 0, scene.centerY + 500, 'gameFont_1', slotControls.getTotalBet(), 60, 1).setOrigin(0.5);
...
//        slotControls.winText.depth = depth;
        ...
        slotControls.winAmountText = scene.add.bitmapText(scene.centerX + 420, scene.centerY + 500, 'gameFont_1', '0', 60, 1).setOrigin(0.5);
